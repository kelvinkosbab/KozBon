...
// MARK: - MockGitHubModelsClient

/// Deterministic stand-in for ``GitHubModelsClient`` in tests and
/// previews.
///
...
/// `streamChat` calls produce a deterministic ordering of recorded
/// requests.
public final class MockGitHubModelsClient: GitHubModelsClientProtocol, Sendable {
    ...
    public struct Recorded: Sendable, Equatable {
        public let request: GitHubMessageRequest
