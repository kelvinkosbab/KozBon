...
// MARK: - Service Type Library
//
// The catalog of every Bonjour service type the app can discover or
// publish. Two read-only arrays expose the public API
// (`tcpServiceTypes`, `udpServiceTypes`); the actual definitions live
// below as `static private let` properties grouped into thematic
// `// MARK:` sections (Apple ecosystem, Smart Home, Media, Printing,
// File Sharing, Mail/Calendar, etc.).
//
// Adding a new type requires three coordinated edits:
//   1. A `static private let` definition in the matching topic
//      section below — keep related types together.
//   2. An entry in `tcpServiceTypes` or `udpServiceTypes`. Each
//      `(type, transportLayer)` pair must be unique across the array.
//   3. A `<string>_<type>._<transport></string>` line in the app's
//      `Info.plist` `NSBonjourServices` array — without it iOS will
//      refuse to scan for the service.
//
// For the canonical service-name list:
// http://www.iana.org/assignments/service-names-port-numbers/service-names-port-numbers.xhtml
// And Apple's reference for ports its own software uses:
...
extension BonjourServiceType {
    ...
    // MARK: - Apple — AirPlay & Audio Streaming
    ...
    // MARK: - Apple — Continuity, Sync, Pairing
    ...
    // MARK: - Apple — iCloud, iTunes, Library Sharing
    ...
    // MARK: - Apple — Server, Admin, Legacy Tools
    ...
    // MARK: - Apple — Remote Desktop & Screen Sharing
    ...
    // MARK: - Smart Home — HomeKit & Matter
    ...
    // MARK: - Smart Home — IoT Frameworks
    ...
    // MARK: - Media — Self-Hosted Servers
    ...
    // MARK: - Media — Streaming Devices & Services
    ...
    // MARK: - Media — Real-Time Streaming Protocols
    ...
    // MARK: - File Sharing — Apple Native
    ...
    // MARK: - File Sharing — Cross-Platform
    ...
    // MARK: - File Sharing — Modern P2P / Cross-Device
    ...
    // MARK: - Calendar & Contacts (RFC 6764)
    ...
    // MARK: - Remote Access — Shell & Terminal
    ...
    // MARK: - Remote Access — Graphical (RFB / VNC / RDP)
    ...
    // MARK: - Networking — Service Discovery
    ...
    // MARK: - Developer Tools — Version Control
    ...
    // MARK: - Developer Tools — Service Mesh & RPC
    ...
    // MARK: - Developer Tools — Design & Productivity
