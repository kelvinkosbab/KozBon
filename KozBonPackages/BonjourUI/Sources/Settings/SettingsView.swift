...
public struct SettingsView: View {
    ...
    public var body: some View {
        NavigationStack {
            ...
            .formStyle(.grouped)
            // Mounted before the platform branches so the wash
            // sits behind the form everywhere. The most muted of
            // the four palettes — this is a screen for reading
            // labels, not for atmosphere.
        ...
        // `WhatsNewView` inherits the Preferences wash.
        .ambientMeshPalette(.preferences)
    }
    ...
    private var isAtDefaults: Bool {
        preferencesStore.aiAnalysisEnabled == UserPreferences.defaultAIAnalysisEnabled
            ...
            && preferencesStore.ambientBackgroundEnabled == UserPreferences.defaultAmbientBackgroundEnabled
