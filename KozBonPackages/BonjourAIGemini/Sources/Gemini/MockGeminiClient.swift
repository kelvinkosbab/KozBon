...
// MARK: - MockGeminiClient

/// Deterministic stand-in for ``GeminiClient`` in tests and
/// previews.
///
...
/// recorded requests.
public final class MockGeminiClient: GeminiClientProtocol, Sendable {
    ...
    public struct Recorded: Sendable, Equatable {
        public let request: GeminiGenerateRequest
