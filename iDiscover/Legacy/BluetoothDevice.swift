...
class BluetoothDevice : NSObject, CBPeripheralDelegate {
    ...
    private lazy var logger = SubsystemCategoryLogger(
        subsystem: "KozBon",
        category: "BluetoothDevice.\(self.uuid)"
    )
    ...
    func peripheral(
        ...
        self.logger.info("Did discover services for bluetooth peripheral")
    ...
    func peripheral(
        ...
        self.logger.info("Did modify services for bluetooth peripheral")
    ...
    func peripheral(_ peripheral: CBPeripheral, didDiscoverCharacteristicsFor service: CBService, error: Error?) {
        self.logger.info("Did discover \(service.characteristics?.count ?? 0) characteristics for service \(service)")
    ...
    func peripheral(_ peripheral: CBPeripheral, didDiscoverDescriptorsFor characteristic: CBCharacteristic, error: Error?) {
        self.logger.info("Did discover \(characteristic.descriptors?.count ?? 0) descriptors for characteristic \(characteristic)")
    ...
    func peripheral(
        ...
        self.logger.info("Did update value for characteristic")
    }
}
