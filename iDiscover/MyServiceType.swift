...
class MyServiceType: Equatable {
  ...
  static let appleMobileDeviceProtocolV2: MyServiceType = MyServiceType(name: "Apple Mobile Device Protocol V2", type: "apple-mobdev2")
